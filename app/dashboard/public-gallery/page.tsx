      ...
      >
        ...
        <header className="flex flex-col md:flex-row justify-between items-end gap-6">
          <div>
            <h1 className="text-5xl font-black   uppercase text-[#F0F4F2] tracking-tighter flex items-center gap-4">
              <Trophy className="text-[#88AB8E]" size={40} /> Showcase
            </h1>
        ...
        {projects.length === 0 ? (
          <div className="text-center py-24 bg-[#243131]/30 rounded-[3.5rem] border border-dashed border-white/10">
            ...
            <p className="text-[#88AB8E]/30 font-bold uppercase tracking-[0.2em] text-[10px] max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project) => (
              <motion.div
                ...
                className="bg-[#243131] rounded-[3.5rem] overflow-hidden border border-white/5 transition-all group"
              >
                {/* Card Header with Gradient */}
                <div className="h-44 bg-gradient-to-br from-[#3E5C58] to-[#243131] p-8 flex items-end relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-30 transition-opacity">
                    <Trophy size={80} className="text-[#88AB8E]" />
                  </div>
                ...
                <div className="p-8 space-y-6">
                  ...
                  {/* Owner Info */}
                  <div className="flex items-center gap-3 py-3 px-4 bg-[#1A2323] rounded-2xl border border-white/5">
                    <div className="w-8 h-8 rounded-lg bg-[#3E5C58] flex items-center justify-center text-[#88AB8E] text-xs font-black uppercase">
                    ...
                    <div className="flex items-center gap-4 pt-4 border-t border-white/5">
                      {project.githubLink && (
                        <a
                          ...
                          className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[#88AB8E] hover:text-[#F0F4F2] transition-colors"
                        >
                          <Github size={16} /> REPO
                        </a>
                      )}
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="text-[9px] font-black uppercase tracking-widest bg-[#1A2323] text-[#F0F4F2]/40 px-4 py-2 rounded-xl flex items-center gap-2 border border-white/5">
                      <Users size={12} className="text-[#88AB8E]" />{" "}
                      {project.memberCount} Members
                    </span>
                    <span className="text-[9px] font-black uppercase tracking-widest bg-[#1A2323] text-[#F0F4F2]/40 px-4 py-2 rounded-xl flex items-center gap-2 border border-white/5">
                      <Calendar size={12} className="text-[#88AB8E]" />{" "}
                  ...
                  <Link
                    ...
                    className="block w-full py-3 bg-[#88AB8E]/10 text-[#88AB8E] rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] text-center hover:bg-[#88AB8E] hover:text-[#141C1C] transition-all border border-[#88AB8E]/20"
                  >
                    View Details
                  </Link>
                </div>
